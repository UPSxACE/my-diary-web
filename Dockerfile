...
ARG NEXT_SERVER_API_BASEURL
ENV NEXT_SERVER_API_BASEURL=${NEXT_SERVER_API_BASEURL}
ARG NEXT_SERVER_JWT_SECRET
ENV NEXT_SERVER_JWT_SECRET=${NEXT_SERVER_JWT_SECRET}
ARG NEXT_BUILD_STANDALONE
